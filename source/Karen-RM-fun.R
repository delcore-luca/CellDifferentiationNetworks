get.modelList <- function(){
  ...
  model.lst[[1]] <- list(rct.lst = c("HSC->MPP",
                                     ...
                                     "T->0"),
                         constr.lst = c(
                           "theta\\[\\'MEP->P\\'\\]=(theta\\[\\'GMP->M\\'\\] + theta\\[\\'GMP->G\\'\\])/2",
                           "theta\\[\\'MEP->ERY\\'\\]=(theta\\[\\'GMP->M\\'\\] + theta\\[\\'GMP->G\\'\\])/2",
                           "theta\\[\\'CMLP->MEP\\'\\]=(theta\\[\\'GMP->M\\'\\] + theta\\[\\'GMP->G\\'\\])",
                           "theta\\[\\'CMLP->GMP\\'\\]=(theta\\[\\'GMP->G\\'\\] + theta\\[\\'GMP->M\\'\\])",
                           "theta\\[\\'MPP->CMLP\\'\\]=(2*(theta\\[\\'GMP->G\\'\\] + theta\\[\\'GMP->M\\'\\]) + theta\\[\\'CMLP->NK\\'\\] + theta\\[\\'CMLP->B\\'\\] + theta\\[\\'CMLP->T\\'\\])",
                           "theta\\[\\'HSC->MPP\\'\\]=(2*(theta\\[\\'GMP->G\\'\\] + theta\\[\\'GMP->M\\'\\]) + theta\\[\\'CMLP->NK\\'\\] + theta\\[\\'CMLP->B\\'\\] + theta\\[\\'CMLP->T\\'\\])",
                           ##
                           "theta\\[\\'P->0\\'\\]=(theta\\[\\'M->0\\'\\] + theta\\[\\'G->0\\'\\])/2",
                           "theta\\[\\'ERY->0\\'\\]=(theta\\[\\'M->0\\'\\] + theta\\[\\'G->0\\'\\])/2",
                           "theta\\[\\'MEP->1\\'\\]=theta\\[\\'GMP->1\\'\\]"
                         ),
                         latSts.lst = c("HSC", "MPP", "CMLP", "MEP", "GMP", "P", "ERY"))
  ...
  model.lst[[2]] <- list(rct.lst = c("HSC->MPP",
                         ...
                         constr.lst = c(
                           ...
                           "theta\\[\\'MEP->ERY\\'\\]=(theta\\[\\'GMP->M\\'\\] + theta\\[\\'GMP->G\\'\\])/2",
                           ##
                           "theta\\[\\'CMP->MEP\\'\\]=(theta\\[\\'GMP->M\\'\\] + theta\\[\\'GMP->G\\'\\])",
                           "theta\\[\\'CMP->GMP\\'\\]=(theta\\[\\'GMP->G\\'\\] + theta\\[\\'GMP->M\\'\\])",
                           "theta\\[\\'MPP->CMP\\'\\]=(2*(theta\\[\\'GMP->G\\'\\] + theta\\[\\'GMP->M\\'\\]))",
                           "theta\\[\\'MPP->CLP\\'\\]=(theta\\[\\'CLP->T\\'\\] + theta\\[\\'CLP->B\\'\\] + theta\\[\\'CLP->NK\\'\\])",
                           "theta\\[\\'HSC->MPP\\'\\]=(2*(theta\\[\\'GMP->G\\'\\] + theta\\[\\'GMP->M\\'\\]) + theta\\[\\'CLP->T\\'\\] + theta\\[\\'CLP->B\\'\\] + theta\\[\\'CLP->NK\\'\\])",
                           ##
                           "theta\\[\\'P->0\\'\\]=(theta\\[\\'M->0\\'\\] + theta\\[\\'G->0\\'\\])/2",
                           "theta\\[\\'ERY->0\\'\\]=(theta\\[\\'M->0\\'\\] + theta\\[\\'G->0\\'\\])/2",
                           "theta\\[\\'MEP->1\\'\\]=(theta\\[\\'GMP->1\\'\\])"
                         ),
                         latSts.lst = c("HSC", "MPP", "CMP", "CLP", "MEP", "GMP", "P", "ERY"))
  ...
  model.lst[[3]] <- list(rct.lst = c("HSC->MPP",
                         ...
                         constr.lst = c(
                           ...
                           "theta\\[\\'CMP->MEP\\'\\]=(theta\\[\\'GMP->M\\'\\] + theta\\[\\'GMP->G\\'\\])",
                           "theta\\[\\'CMP->GMP\\'\\]=(theta\\[\\'GMP->G\\'\\] + theta\\[\\'GMP->M\\'\\])",
                           "theta\\[\\'MPP->CMP\\'\\]=(2*(theta\\[\\'GMP->M\\'\\] + theta\\[\\'GMP->G\\'\\]) + theta\\[\\'CMP->NK\\'\\])",
                           "theta\\[\\'MPP->CLP\\'\\]=(theta\\[\\'CLP->T\\'\\] + theta\\[\\'CLP->B\\'\\] +  theta\\[\\'CLP->NK\\'\\])",
                           "theta\\[\\'HSC->MPP\\'\\]=(2*(theta\\[\\'GMP->M\\'\\] + theta\\[\\'GMP->G\\'\\]) + theta\\[\\'CMP->NK\\'\\] + theta\\[\\'CLP->T\\'\\] + theta\\[\\'CLP->B\\'\\] +  theta\\[\\'CLP->NK\\'\\])",
                           ##
                           "theta\\[\\'P->0\\'\\]=(theta\\[\\'M->0\\'\\] + theta\\[\\'G->0\\'\\])/2",
                           "theta\\[\\'ERY->0\\'\\]=(theta\\[\\'M->0\\'\\] + theta\\[\\'G->0\\'\\])/2",
                           "theta\\[\\'MEP->1\\'\\]=(theta\\[\\'GMP->1\\'\\])"
  ...
  model.lst[[4]] <- list(rct.lst = c("HSC->MPP",
                         ...
                         constr.lst = c(
                           ...
                           "theta\\[\\'CMP->MEP\\'\\]=(theta\\[\\'GMP->M\\'\\] + theta\\[\\'GMP->G\\'\\])",
                           "theta\\[\\'CMP->GMP\\'\\]=(theta\\[\\'GMP->G\\'\\] + theta\\[\\'GMP->M\\'\\])",
                           "theta\\[\\'MPP->CMP\\'\\]=(2*(theta\\[\\'GMP->M\\'\\] + theta\\[\\'GMP->G\\'\\]))",
                           "theta\\[\\'MPP->NKP\\'\\]=(theta\\[\\'NKP->NK\\'\\])",
                           "theta\\[\\'MPP->CLP\\'\\]=(theta\\[\\'CLP->T\\'\\] + theta\\[\\'CLP->B\\'\\])",
                           "theta\\[\\'HSC->MPP\\'\\]=(2*(theta\\[\\'GMP->M\\'\\] + theta\\[\\'GMP->G\\'\\]) + theta\\[\\'NKP->NK\\'\\] + theta\\[\\'CLP->T\\'\\] + theta\\[\\'CLP->B\\'\\])",
                           ##
                           "theta\\[\\'P->0\\'\\]=(theta\\[\\'M->0\\'\\] + theta\\[\\'G->0\\'\\])/2",
                           "theta\\[\\'ERY->0\\'\\]=(theta\\[\\'M->0\\'\\] + theta\\[\\'G->0\\'\\])/2",
                           "theta\\[\\'MEP->1\\'\\]=(theta\\[\\'GMP->1\\'\\])"
                         ),
                         latSts.lst = c("HSC", "MPP", "CMP", "NKP", "CLP", "MEP", "GMP", "P", "ERY"))
